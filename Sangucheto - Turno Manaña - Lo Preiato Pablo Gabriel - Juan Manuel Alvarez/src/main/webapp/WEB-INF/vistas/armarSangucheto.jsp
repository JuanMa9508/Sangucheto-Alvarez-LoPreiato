      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="http://localhost:8080/Sangucheto/armarSangucheto">Arma tu sangucheto</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
	<div class="page-header">
		<br><h1>Eleji los productos para tu sangucheto:</h1>
	</div>
	<div class="row">
...
<form:form action="agregarAlCarrito" modelAttribute="producto" method="POST">
...
<form:form action="carrito"  method="POST">
<td><button type="submit" class="btn btn-success">Confirmar</button></td>
        ...
        <strong>${mensajeResumen}</strong>${mensajeDetallado }
						...
						Nota:Se realizara un descuento del 10% en el total del producto, si el valor del mismo supera los $125.
					</div>
				</div>
			</div>
			</div>
